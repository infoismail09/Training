...
class UserReggistrationView(APIView):
    ...
    def post(self,request,format=None):
        ...
        # print(serializer.errors)  # if we want to see what error had came while regis then simple remove exception from is _valid and print this line you can see error in terminal and created rendered.py
