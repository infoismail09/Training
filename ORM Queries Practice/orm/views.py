...
def get_album(request):
    ...
    print()
    print(details.query)
    return HttpResponse("<h1>Welcome to My Object Relational Mapping <br>Album</br></h1>")
...
def get_song(request):
    ...
    print(details)
    return HttpResponse("<h1>Welcome to My Object Relational Mapping <br>Song</br></h1>")
